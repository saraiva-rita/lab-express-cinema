...
// This part is to insert the movies that we have in this file connected with MONGO DB
async function insertMovies() {
  try {
    ...
    // Create movies in our database with the seeds array
    let moviesCreated = await Movie.create(movies);

    // Feedback about movies creation
